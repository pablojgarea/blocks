...
class PruebaMiniaturaBlockController extends BlockController {
	
	protected $btName = 'prueba_miniatura';
	protected $btDescription = '';
	protected $btTable = 'btDCPruebaMiniatura';
	...
	public function view() {
		$this->set('field_1_image', (empty($this->field_1_image_fID) ? null : $this->get_image_object($this->field_1_image_fID, 100, 100, false)));
	}
