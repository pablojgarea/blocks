...
echo '<div class="row">'; //opens the top-level menu

foreach ($navItems as $ni) {

	echo '<div class="item-listado panel panel-default col-md-3 ' . $ni->classes . '">'; //opens a nav item

	echo '<div class="cuadro-menu"><a href="' . $ni->url . '" target="' . $ni->target . '" class="' . $ni->classes . '">' . $ni->name . '</a></div>';
    echo '</div>';
}
